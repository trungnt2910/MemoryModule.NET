...
namespace DemoApp.Abstracts.Windows
{
    unsafe class Program
    {
        ...
        {
            var asm = Assembly.GetExecutingAssembly().GetManifestResourceStream($"DemoApp.Abstracts.Windows.Tls{(Environment.Is64BitProcess ? "64" : "")}.dll") as UnmanagedMemoryStream;
